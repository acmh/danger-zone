...
<img src="dangerzone-example.png" alt="danger-zone in action: a rails console in production wrapped top and bottom by blood-red DANGER banners" width="600" />

<img src="architecture.svg" alt="Architecture" width="700" />
